...
def main():
    ...
    parser.add_argument(
        "--history_model",
        default="nohistory",
        help="which history model to use, nohistory or kp (keyphrase) or qs (question selector) or coref (coreference resolution)",
    )

    args = parser.parse_args()
    if args.history_model == "kp":
        args.dataset_name = "hf_datasets/doc2dial/doc2dial_pub_kp.py"
    if args.history_model == "qs":
        args.dataset_name = "hf_datasets/doc2dial/doc2dial_pub_qs.py"
    if args.history_model == "coref":
        args.dataset_name = "hf_datasets/doc2dial/doc2dial_pub_coref.py"
